...
def test_header_message_with_variable():
    ...
    assert api.header == {'Context': {'CatalogID': header_message['Context']['CatalogID'],
                                      'ConfigurationPolicy': None,
                                      'CustomerID': None,
                                      'CustomerId': None,
                                      'CustomerNumber': None,
                          ...
                          'Localization': {'Country': header_message['Localization']['Country'],
                                           'CultureName': None,
                                           'Currency': None,
                                           'DecimalPosition': None,
                                           'Language': None},
                          'Security': {'DomainRightsList': None,
                                       'IssuerID': None,
                                       'SessionID': None,
                                       'SubjectLocality': None,
                                       'TokenId': api.token,
